...
public class CompanyConfiguration : IEntityTypeConfiguration<Company>
{
    public void Configure(EntityTypeBuilder<Company> builder)
    {
        ...
        builder.Property(c => c.OfficialEmail)
            .HasMaxLength(250);
        ...
        builder.Property(c => c.TrustLevel)
            .HasMaxLength(50);
        ...
        builder.HasOne(c => c.Verification)
            .WithOne(v => v.Company)
            .HasForeignKey<CompanyVerification>(v => v.CompanyId)
            .OnDelete(DeleteBehavior.Cascade);
        ...
        // Company -> Talent Pool
        // NoAction avoids SQL Server multiple cascade path error.
        builder.HasMany(c => c.TalentPoolEntries)
            .WithOne(t => t.Company)
