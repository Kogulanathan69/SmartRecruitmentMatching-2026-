...
public interface IAuthService
{
    ...
    Task<bool> VerifyEmailOtpAsync(VerifyEmailOtpRequestDto dto, CancellationToken ct = default);
    Task<bool> ResendEmailOtpAsync(ResendEmailOtpRequestDto dto, CancellationToken ct = default);
